...
export default function XMockCreator() {
  ...
  return (
    <main className={cls("relative min-h-[100dvh]", theme.page, settings.fullScreenMode && "fixed inset-0 z-40 h-[100dvh] w-screen overflow-hidden")} style={{ backgroundColor: settings.bgColor || undefined }}>
      {phone}
