...
import { mockStageStyle, PIXEL_10_PRO_ASPECT_RATIO, usePseudoFullscreen } from "./usePseudoFullscreen";
      ...
      {deviceFrameMode ? (
        <div ref={scrollRef} className="relative flex-1 min-h-0 overflow-hidden bg-black">
          <div className="absolute inset-0 flex items-center justify-center p-1">
            <div className="relative h-full max-h-full w-auto max-w-full" style={{ aspectRatio: PIXEL_10_PRO_ASPECT_RATIO }}>
              ...
              {activeTab === "screen" && (
                <div className="space-y-4">
                  ...
                  <SectionCard icon={Settings2} title="操作表示">
                    ...
                    <div className="flex items-center justify-between rounded-2xl border border-black/10 p-3"><div><div className="text-sm font-medium">フルスクリーンモード</div><div className="text-xs text-black/50">ONはPixel 10 Proのカメラ穴・角・下部操作領域を避けて表示。OFFも左右いっぱいに表示します</div></div><Switch checked={fullScreenMode} onCheckedChange={(value) => { setFullScreenMode(value); }} /></div>
